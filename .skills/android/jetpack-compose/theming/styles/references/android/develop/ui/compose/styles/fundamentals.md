...
> [!NOTE]
> **Note:** Whilst the Style APIs are experimental, you need to opt-in to enable Style inheritance
> by setting the flag `ComposeFoundationFlags.isInheritedTextStyleEnabled = true`.
