...
> the user's given name, family name, name, and the profile picture of their Google Account.
> However,
...
> Note that you can't request a phone number and email in the same invocation as these are separate
> capabilities.
